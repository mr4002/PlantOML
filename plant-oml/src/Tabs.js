...
import Tab from "./Tab";
import { updateImage } from "./App.js"
import "./App.css";
...
const Tabs = ({ tabs }) => {
	...
	const handleTabClick = (index) => {
		setActiveTab(index);
        if(index === 0){
            fieldRef.current.placeholder = "OML normal string"
        }else if(index === 1){
            fieldRef.current.placeholder = "OML hex string"
        }else{
            fieldRef.current.placeholder = "OML deflated string"
        }
	};
	...
	return (
		<div className="tabs-container">
			...
			<div className="tab-content" >
                ...
                <label>
                    <textarea placeholder = "OML normal string" ref={fieldRef}  name="omlcode" id="textfield"/>
                </label>
